...
describe "GET sensit/fields#show" do
	...
	def process_request(topic)
		...
		get "/api/topics/#{topic.to_param}/fields/#{field.to_param}", valid_request, valid_session(:user_id => topic.user.to_param)
	end
	...
	context "when the field does not exist" do
		it "is unsuccessful" do
			expect{
				status = get "/api/topics/1/fields/1", valid_request, valid_session(:user_id => @user.to_param)
