  ...
  describe NodesController do
    ...
    describe "GET show" do
      it "assigns the requested node as @node" do
        node = Node.create! valid_attributes
        get :show, valid_request({:id => node.to_param}), valid_session
    ...
    describe "POST create" do
      describe "with valid params" do
        it "creates a new Node" do
          expect {
            post :create, valid_request({:node => valid_attributes}), valid_session
        ...
        it "redirects to the created node" do
          post :create, valid_request({:node => valid_attributes}), valid_session
          response.should render_template("sensit/nodes/show")
        end
      end
      ...
      describe "with invalid params" do
        it "assigns a newly created but unsaved node as @node" do
          ...
          post :create, valid_request({:node => { "name" => "invalid value" }}), valid_session
    ...
    describe "PUT update" do
      describe "with valid params" do
        it "updates the requested node" do
          ...
          Node.any_instance.should_receive(:update).with({ "name" => "NewString" })
          put :update, valid_request({:id => node.to_param, :node => { "name" => "NewString" }}), valid_session
        end
      ...
      describe "with invalid params" do
        it "assigns the node as @node" do
          ...
          # Trigger the behavior that occurs when invalid params are submitted
          Node.any_instance.stub(:save).and_return(false)
          put :update, valid_request({:id => node.to_param, :node => { "name" => "invalid value" }}), valid_session
          assigns(:node).should eq(node)
        end
    ...
    describe "DELETE destroy" do
      it "destroys the requested node" do
        node = Node.create! valid_attributes
        expect {
          delete :destroy, valid_request({:id => node.to_param}), valid_session
        }.to change(Node, :count).by(-1)
      end
