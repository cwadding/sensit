  ...
  describe DevicesController do
    ...
    describe "GET show" do
      it "assigns the requested device as @device" do
        device = Device.create! valid_attributes
        get :show, valid_request({:id => device.to_param}), valid_session
    ...
    describe "POST create" do
      describe "with valid params" do
        it "creates a new Device" do
          expect {
            post :create, valid_request({:device => valid_attributes}), valid_session
        ...
        it "redirects to the created device" do
          post :create, valid_request({:device => valid_attributes}), valid_session
          response.should render_template("sensit/devices/show")
        end
      end
      ...
      describe "with invalid params" do
        it "assigns a newly created but unsaved device as @device" do
          ...
          post :create, valid_request({:device => { "title" => "invalid value" }}), valid_session
    ...
    describe "PUT update" do
      describe "with valid params" do
        it "updates the requested device" do
          ...
          Device.any_instance.should_receive(:update).with({ "title" => "MyString" })
          put :update, valid_request({:id => device.to_param, :device => { "title" => "MyString" }}), valid_session
        end

        it "assigns the requested device as @device" do
          device = Device.create! valid_attributes
          put :update, valid_request({:id => device.to_param, :device => valid_attributes}), valid_session
          assigns(:device).should eq(device)
        end
      ...
      describe "with invalid params" do
        it "assigns the device as @device" do
          ...
          # Trigger the behavior that occurs when invalid params are submitted
          Device.any_instance.stub(:save).and_return(false)
          put :update, valid_request({:id => device.to_param, :device => { "title" => "invalid value" }}), valid_session
          assigns(:device).should eq(device)
        end
    ...
    describe "DELETE destroy" do
      it "destroys the requested device" do
        device = Device.create! valid_attributes
        expect {
          delete :destroy, valid_request({:id => device.to_param}), valid_session
        }.to change(Device, :count).by(-1)
      end
