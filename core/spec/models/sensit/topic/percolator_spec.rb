...
module Sensit
  describe Topic::Percolator do
    ...
    describe "#create" do
        ...
        before(:each) do
            @indices_client = Elasticsearch::API::Indices::IndicesClient.new(@client)
            @percolator = Topic::Percolator.new({type: 'mytype', id: 'myrule', body: { query: { query_string: { query: 'foo' } } } })
    ...
    describe "#update" do
        before(:each) do
            @percolator = Topic::Percolator.new({type: 'mytype', id: 3, body: {query: { query_string: { query: 'foo' } } }})
